...
namespace LibraryPlusAssignment
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("=========Running DisplayTopThree() Test ==========");
            //MemberCollection memberCollection = MemberCollection.GetInstance();
            //Member? testMember = memberCollection.MemberLogIn("ti", "to", "1000");

            //if (testMember != null)
            //{
            //    MovieCollection movieCollection = MovieCollection.GetInstance();
            //    testMember.DisplayTopThree(movieCollection);
            //}
            //else
            //{
            //    Console.WriteLine("Test member not found.");
            //}
